...
const startServer = async () => {
  try {
    ...
    await mongoose.connect(process.env.MONGODB_URI || "mongodb+srv://stuvspro:%23CrackiT@cluster0.1acee.mongodb.net/myntra-clone?retryWrites=true&w=majority&appName=Cluster0", {
      retryWrites: true,
      w: 'majority'
    });
